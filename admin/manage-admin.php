        ...
        <div class="main-content">
            <div class="wrapper">
                ...
                <table class="tbl-full">
                    <figcaption class="text-center"><h2>Admins</h2></figcaption>
                ...
                <!-- Vendors -->
                <table class="tbl-full">
                    <figcaption class="text-center"><h2>Vendors</h2></figcaption>
                    <tr class="text-center">
                        <th>S.N.</th>
                        <th>Full Name</th>
                        <th>Username</th>
